...
class Logger:
    def __init__(self, sess,config):
        ...
        self.train_summary_writer = tf.summary.FileWriter(os.path.join(self.config.summary_dir, "train"),
                                                          self.sess.graph)
        self.dev_summary_writer = tf.summary.FileWriter(os.path.join(self.config.summary_dir, "dev"),
                                                          self.sess.graph)
    ...
    def summarize(self, step, summarizer="train", scope="", summaries_dict=None):
        ...
        :param summarizer: use the train summary writer dev summary writer or the test one
        ...
        if summarizer == "train":
            ...
            if summarizer == "dev":
                summary_writer = self.dev_summary_writer
            else:
